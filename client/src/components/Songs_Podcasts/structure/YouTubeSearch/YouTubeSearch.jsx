    ...
    return (
        ...
        >
            {videos.length > 0 ? (
                ...
                <h1 className={style['not-results-founded']}>Не са намерени резултати, проверете отново дали сте въвели правилно исканато от Вас или го заявете в "Заяви Песен/Подкаст"..</h1>
            )}
